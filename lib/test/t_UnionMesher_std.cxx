...
int main()
{
  ...
  // 8. CompressMesh: collapse duplicate vertices
  {
    ...
    assert_equal(compressed.getVerticesNumber(), 4UL);
  ...
  // 10. build with a mesh that has an unused vertex
  {
    ...
    assert_equal(unionMesh.getVerticesNumber(), 4UL);
  ...
  // 11. Empty input mesh
  {
    ...
    assert_equal(single.getDimension(), 2UL);
    assert_equal(single.getVerticesNumber(), 0UL);
    assert_equal(single.getSimplicesNumber(), 0UL);
  }
  ...
  // 12. Two empty meshes
  {
    ...
    assert_equal(unionMesh.getDimension(), 2UL);
    assert_equal(unionMesh.getVerticesNumber(), 0UL);
    assert_equal(unionMesh.getSimplicesNumber(), 0UL);
  }
